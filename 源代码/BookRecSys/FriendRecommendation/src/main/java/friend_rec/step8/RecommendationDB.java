...
public class RecommendationDB implements DBWritable,
	...
	public RecommendationDB(Text id, Text friend_id, DoubleWritable preference) {
		this();
	...
	public Text getFriend_id() {
		return friend_id;
	}

	public void setFriend_id(Text friend_id) {
		this.friend_id.set(friend_id.toString());
	}
	...
	// .getPreference()) : friend_id.compareTo(o.getFriend_id());
	// }
	...
	public int compareTo(RecommendationDB o) {
		return id.compareTo(o.getId()) != 0 ? id.compareTo(o.getId())
				: preference.compareTo(o.getPreference()) != 0 ? preference
						.compareTo(o.getPreference()) : friend_id.compareTo(o
						.getFriend_id());
	}
	...
	public void write(PreparedStatement statement) throws SQLException {
		...
		statement.setString(3, getFriend_id().toString());
	...
	public void readFields(ResultSet resultSet) throws SQLException {
		...
		setFriend_id(resultSet.getString(2));
