...
import book_rec.step4.Preference;
...
public class ReduceJoinTest extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Path coMatrix = new Path("/BookRec/step3");
		Path refMatrix = new Path("/BookRec/step4");
		Path output = new Path("/BookRec/step5");
